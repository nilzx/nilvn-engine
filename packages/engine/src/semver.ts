...
// MIRROR of packages/core/src/semver.ts (the engine holds no runtime dependency
// on core); the core↔engine contract test pins the two copies byte-equal below
// this header — edit core's copy and re-copy.
